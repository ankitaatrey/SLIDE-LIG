...
public class SampleService extends Application<SampleServiceConfiguration> {
    ...
    public void initialize(Bootstrap<SampleServiceConfiguration> bootstrap) {
        //Nothing to do
        DataLoader.loadAllNutritionTweets("../nutritionLabel.csv");
        DataLoader.loadAllHealthTweets("../healthLabel.csv");
//        DataLoader.loadAllNutritionTweets("../tweetLabels.csv", true);
